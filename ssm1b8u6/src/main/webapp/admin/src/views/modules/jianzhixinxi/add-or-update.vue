<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司类型" prop="gongsileixing">
          <el-input v-model="ruleForm.gongsileixing" 
              placeholder="公司类型" clearable  :readonly="ro.gongsileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司类型" prop="gongsileixing">
              <el-input v-model="ruleForm.gongsileixing" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="招聘状态" prop="zhaopinzhuangtai">
          <el-select v-model="ruleForm.zhaopinzhuangtai" placeholder="请选择招聘状态">
            <el-option
                v-for="(item,index) in zhaopinzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="招聘状态" prop="zhaopinzhuangtai">
	      <el-input v-model="ruleForm.zhaopinzhuangtai"
                placeholder="招聘状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="招聘要求" prop="zhaopinyaoqiu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaopinyaoqiu" label="招聘要求" prop="zhaopinyaoqiu">
                    <span v-html="ruleForm.zhaopinyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhaopinyaoqiu = this.ruleForm.zhaopinyaoqiu.replace(reg,'../../../ssm1b8u6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
