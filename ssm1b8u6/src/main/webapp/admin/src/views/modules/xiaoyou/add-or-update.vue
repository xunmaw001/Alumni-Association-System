<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="毕业年份" prop="biyenianfen">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.biyenianfen" label="毕业年份" prop="biyenianfen">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作岗位" prop="gongzuogangwei">
          <el-input v-model="ruleForm.gongzuogangwei" 
              placeholder="工作岗位" clearable  :readonly="ro.gongzuogangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作岗位" prop="gongzuogangwei">
              <el-input v-model="ruleForm.gongzuogangwei" 
                placeholder="工作岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
