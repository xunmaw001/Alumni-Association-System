<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="校友名" prop="xiaoyouming">
          <el-input v-model="ruleForm.xiaoyouming" 
              placeholder="校友名" clearable  :readonly="ro.xiaoyouming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="校友名" prop="xiaoyouming">
              <el-input v-model="ruleForm.xiaoyouming" 
                placeholder="校友名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="生活动态" prop="shenghuodongtai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shenghuodongtai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenghuodongtai" label="生活动态" prop="shenghuodongtai">
                    <span v-html="ruleForm.shenghuodongtai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工作心得" prop="gongzuoxinde">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongzuoxinde" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuoxinde" label="工作心得" prop="gongzuoxinde">
                    <span v-html="ruleForm.gongzuoxinde"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='shenghuodongtai'){
            this.ruleForm.shenghuodongtai = obj[o];
	    this.ro.shenghuodongtai = true;
            continue;
          }
          if(o=='gongzuoxinde'){
            this.ruleForm.gongzuoxinde = obj[o];
	    this.ro.gongzuoxinde = true;
            continue;
          }
          if(o=='thumbsupnum'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.xiaoyouming!=''&&json.xiaoyouming){
              		this.ruleForm.xiaoyouming = json.xiaoyouming
		}
	...
	this.ruleForm.shenghuodongtai = this.ruleForm.shenghuodongtai.replace(reg,'../../../ssm1b8u6/upload');
	this.ruleForm.gongzuoxinde = this.ruleForm.gongzuoxinde.replace(reg,'../../../ssm1b8u6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shenghuomokuai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenghuomokuaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
